...
QString tokenToString(const Token token)
{
    ...
    if (token == S_SPACE) {
        ...
        switch (token) {
            ...
            case T_ID:
                s = QString::fromUtf8("[id]");
                break;
            case T_CONST:
                s = QString::fromUtf8("[const]");
                break;
            ...
            case N_S:
                ...
                break;
            case N_PROGRAM:
                s = QString::fromUtf8("<program>");
                break;
            case N_PROG_ELEMENT:
                s = QString::fromUtf8("<program_element>");
                break;
            case N_CLASS:
                s = QString::fromUtf8("<class>");
                break;
            case N_CLASS_BODY:
                s = QString::fromUtf8("<class_body>");
                break;
            case N_CLASS_ELEMENT:
                s = QString::fromUtf8("<class_element>");
                break;
            case N_ACCESS_SPEC:
            ...
            case N_ARGUMENT:
                ...
                break;
            case N_BLOCK:
                s = QString::fromUtf8("<block>");
                break;
            case N_BLOCK_BODY:
                s = QString::fromUtf8("<block_body>");
                break;
            case N_BLOCK_ELEMENT:
                s = QString::fromUtf8("<block_element>");
                break;
            case N_RETURN:
                s = QString::fromUtf8("<return>");
                break;
            case N_EXPRESSION:
                s = QString::fromUtf8("<expression>");
                break;
            case N_OP_1:
                s = QString::fromUtf8("<operator_1>");
                break;
            case N_OP_2:
                s = QString::fromUtf8("<operator_2>");
                break;
            case N_OP_3:
                s = QString::fromUtf8("<operator_3>");
                break;
            case N_OP_4:
                s = QString::fromUtf8("<operator_4>");
                break;
            case N_OP_5:
                s = QString::fromUtf8("<operator_5>");
                break;
            case N_OP_6:
                s = QString::fromUtf8("<operator_6>");
                break;
            case N_OP_7:
                s = QString::fromUtf8("<operator_7>");
                break;
            case N_OP_8:
                s = QString::fromUtf8("<operator_8>");
                break;
            case N_OP_9:
                s = QString::fromUtf8("<operator_9>");
                break;
            case N_FUNC_CALL:
                s = QString::fromUtf8("<function_call>");
                break;
            case N_OBJECT:
...
QString TokenPointer::toString() const
{
    ...
    res = ((type != EOF_TOKEN) ? QString("%1[%2]").arg(table).arg(index) : QString::number(index));
    return res;
}
...
QString Block::toString() const
{
    ...
    res = QString("{ parent: #%1, declared_symbols: [%2] }").arg(parent_block_index).arg(declared_symbols.join(", "));
...
QSet<Token> getAllTerminalTokens()
{
    ...
    for (int token = UNKNOWN; token <= EOF_TOKEN; token++) {
        if ((token == T_ID) || (token == T_CONST) || (token == EOF_TOKEN) || isTokenKeyword((Token)token)
