<программа> ::= {<элемент_программы>}int main([<список_аргументов>])"{"{<элемент_блока>}"}"{<элемент_программы>}
...
<метод_класса> ::= [<тип_функции> ][~]<идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
<реализация_метода_класса> ::= [<тип_функции> ]<идентификатор>::[~]<идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
<функция> ::= <тип_функции> <идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
