...
<метод_класса> ::= [((<тип_переменной>|void) |~)]<идентификатор>"("[<список_аргументов>]")"<блок_со_скобками>
<реализация_метода_класса> ::= ([(<тип_переменной>|void) ]<идентификатор>::|<идентификатор>::~)<идентификатор>"("[<список_аргументов>]")"<блок_со_скобками>
<функция> ::= (<тип_переменной>|void) <идентификатор>"("[<список_аргументов>]")"<блок_со_скобками>
<список_аргументов> ::= {<список_аргументов>,}<аргумент>
<аргумент> ::= [const ]<тип_переменной> [&]<идентификатор>
<блок> ::= (<элемент_блока>|<блок_со_скобками>)
<блок_со_скобками> ::= "{"{<элемент_блока>}"}"
