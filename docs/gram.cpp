...
<метод_класса> ::= [((<тип_переменной>|void) |~)]<идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
<реализация_метода_класса> ::= ([(<тип_переменной>|void) ]<идентификатор>::|<идентификатор>::~)<идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
<функция> ::= (<тип_переменной>|void) <идентификатор>"("[<список_аргументов>]"){"{<элемент_блока>}"}"
