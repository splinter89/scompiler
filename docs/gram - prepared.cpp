...
<элемент_класса> ::= <спецификатор_доступа>:
<элемент_класса> ::= <спецификатор_доступа>:<декларация_свойств_класса>
<элемент_класса> ::= <спецификатор_доступа>:<метод_класса>
<элемент_класса> ::= <спецификатор_доступа>:<элемент_класса><декларация_свойств_класса>
<элемент_класса> ::= <спецификатор_доступа>:<элемент_класса><метод_класса>

<спецификатор_доступа> ::= public
<спецификатор_доступа> ::= private

<метод_класса> ::= <идентификатор>"()"<блок_со_скобками>
<метод_класса> ::= <идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<метод_класса> ::= <тип_переменной> <идентификатор>"()"<блок_со_скобками>
<метод_класса> ::= <тип_переменной> <идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<метод_класса> ::= void <идентификатор>"()"<блок_со_скобками>
<метод_класса> ::= void <идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<метод_класса> ::= ~<идентификатор>"()"<блок_со_скобками>
<метод_класса> ::= ~<идентификатор>"("<список_аргументов>")"<блок_со_скобками>

<реализация_метода_класса> ::= <идентификатор>::<идентификатор>"()"<блок_со_скобками>
<реализация_метода_класса> ::= <идентификатор>::<идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<реализация_метода_класса> ::= <тип_переменной> <идентификатор>::<идентификатор>"()"<блок_со_скобками>
<реализация_метода_класса> ::= <тип_переменной> <идентификатор>::<идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<реализация_метода_класса> ::= void <идентификатор>::<идентификатор>"()"<блок_со_скобками>
<реализация_метода_класса> ::= void <идентификатор>::<идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<реализация_метода_класса> ::= <идентификатор>::~<идентификатор>"()"<блок_со_скобками>
<реализация_метода_класса> ::= <идентификатор>::~<идентификатор>"("<список_аргументов>")"<блок_со_скобками>

<функция> ::= <тип_переменной> <идентификатор>"()"<блок_со_скобками>
<функция> ::= <тип_переменной> <идентификатор>"("<список_аргументов>")"<блок_со_скобками>
<функция> ::= void <идентификатор>"()"<блок_со_скобками>
<функция> ::= void <идентификатор>"("<список_аргументов>")"<блок_со_скобками>
...
<блок> ::= <элемент_блока>
<блок> ::= <блок_со_скобками>

<блок_со_скобками> ::= "{}"
<блок_со_скобками> ::= "{"<тело_блока>"}"
...
<список_переменных> ::= <список_переменных>,<идентификатор>=<выражение>
