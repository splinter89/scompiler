...
<класс> ::= class <идентификатор>"{"<класс_р>"}";
...
<класс_р> ::= <класс_р2>
<класс_р> ::= <спецификатор_доступа>:<класс_р2>
<класс_р> ::= <класс_р><класс_р2>
<класс_р> ::= <класс_р><спецификатор_доступа>:<класс_р2>

<класс_р2> ::= <декларация_свойств_класса>
<класс_р2> ::= <метод_класса>
<класс_р2> ::= <класс_р2><декларация_свойств_класса>
<класс_р2> ::= <класс_р2><метод_класса>
